...
//        stage.getIcons().add(image);
    ...
    void initialize() {
        ...
        login_button.setOnAction(event -> {
            ...
            if (acc_log.equals("Other")) {
                if (loginText.equals("dir") && passText.equals("1234")) {
                    try {
                ...
                } else if(loginText.equals("lib") && passText.equals("1234")){
                    try {
                        login_button.getScene().getWindow().hide();
                        changeScene("librarian1.fxml", login_button);
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                } else res_text.setText("Login or password is incorrect");
            }
